...
mod tests {
    ...
    fn test_position_to_position() {
        let pt1 = Point::new(centi_metre(0.0), centi_metre(3.0));
        let pt2 = Point::new(centi_metre(4.0), centi_metre(0.0));
    ...
    fn test_position_to_line_0() {
        let pt = Point::new(centi_metre(1.0), centi_metre(1.0));
        let p = Point::new(centi_metre(1.0), centi_metre(0.0));
    ...
    fn test_position_to_line_1() {
        let pt = Point::new(centi_metre(1.0), centi_metre(1.0));
        let p = Point::new(centi_metre(5.0), centi_metre(0.0));
        let v = Vector::new(centi_metre(0.0), centi_metre(1.0));
        let line = Line::new(p, v);
        let distance = pt.distance(&line);
    ...
    fn test_position_to_line_2() {
        let pt = Point::new(centi_metre(1.0), centi_metre(1.0));
        let p = Point::new(centi_metre(0.0), centi_metre(5.0));
    ...
    fn test_position_to_line_3() {
        let pt = Point::new(centi_metre(1.0), centi_metre(2.0));
        let p = Point::new(centi_metre(1.0), centi_metre(0.0));
